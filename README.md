...
- [cap-collaborative-draft](#cap-collaborative-draft)
  - [Table of Contents](#table-of-contents)
  - [Overview](#overview)
    - [Preview](#preview)
  - [Installation](#installation)
  - [Quick Start](#quick-start)
    - [1. Annotate your service entity](#1-annotate-your-service-entity)
    - [2. Start your CAP application](#2-start-your-cap-application)
    - [3. Verify the OData contract](#3-verify-the-odata-contract)
  - [How It Works](#how-it-works)
    ...
    - [User Directory](#user-directory)
      - [Mode 1 — Entity-backed (recommended for production)](#mode-1--entity-backed-recommended-for-production)
      - [Mode 2 — Static map (development / small environments)](#mode-2--static-map-development--small-environments)
  ...
  - [Development and Testing](#development-and-testing)
    - [Starting the test app](#starting-the-test-app)
    - [Verifying the OData contract](#verifying-the-odata-contract)
...
![Preview](docs/cap-collaborative-draft-preview.png)
...
```bash
npm add cap-collaborative-draft@1.0.0
```
...
**Source:** [github.com/sleibach/cap-collaborative-draft](https://github.com/sleibach/cap-collaborative-draft)
**npm:** [npmjs.com/package/cap-collaborative-draft](https://www.npmjs.com/package/cap-collaborative-draft)

**Peer dependency:** `@sap/cds >= 8.0`

**Required peer dependency:** `@cap-js-community/websocket` — the plugin registers a WebSocket relay service for real-time presence updates, participant avatars, and field-lock indicators. Without it, the Fiori Elements collaborative draft UI will not function: participants won't see each other, field locks won't appear, and no live updates will occur. The plugin will still start, but collaborative draft is effectively broken in pull-only mode.
